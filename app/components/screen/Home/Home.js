    ...
    render() {
        return (
            ...
            <View style={styles.Container}>
                <Header title={translate("Home.WELCOME")} menuBar={true} action={() => this.props.navigation.openDrawer()} />
                <View style={styles.ButtonView}>
                    <View>
                        <TouchableOpacity style={styles.touch} onPress={() => this.props.navigation.navigate("EmployeeList")}>
                            ...
                            <Text style={styles.ButtonText}>{translate("Home.Employee List")}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ paddingTop: 10 }}>
                        <TouchableOpacity style={styles.touch} onPress={() => this.props.navigation.navigate("ProductDetail")}>
                            ...
                            <Text style={styles.ButtonText}>{translate("Home.Product Details")}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ paddingTop: 10 }}>
                        <TouchableOpacity style={styles.touch} onPress={() => this.props.navigation.navigate("AttendanceSheet")}>
                            ...
                            <Text style={styles.ButtonText}>{translate("Home.Attendance Sheet")}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
